...
def _run_schema_repairs() -> None:
    ...
    with engine.connect() as conn:
        for table, column, ddl in [
            ...
            ("companies", "contact_phone", "ALTER TABLE companies ADD COLUMN contact_phone VARCHAR(20)"),
...
from app.api.routes import (
    ...
    bank_accounts, opportunities, public_share,
)
...
app.include_router(public_share.router, prefix="/api/public", tags=["Public"])
